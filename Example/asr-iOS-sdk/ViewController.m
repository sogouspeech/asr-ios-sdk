...
- (void)viewDidLoad {
    ...
    [SogouSpeechPropertySetting setProperty:@YES forKey:ASR_ONLINE_ENABLE_DEBUG_LOG_BOOL];
...
#error 填写将要使用的服务域名
    ...
    [SogouSpeechPropertySetting setProperty:@NO forKey:ASR_ONLINE_VAD_ENABLE_BOOL];
    [SogouSpeechPropertySetting setProperty:@YES forKey:ASR_ONLINE_ENABLE_DEBUG_LOG_BOOL];
